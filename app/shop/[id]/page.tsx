                ...
                <div className="container mx-auto max-w-6xl">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                <h2 className="text-base sm:text-lg font-medium mb-3">Description</h2>
                    ...
                    <div className="mt-12 sm:mt-16">
                        <h2 className="text-xl sm:text-2xl font-playfair font-medium mb-6 sm:mb-8">You might also like</h2>
